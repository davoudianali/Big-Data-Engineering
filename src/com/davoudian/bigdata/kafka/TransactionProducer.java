package com.davoudian.bigdata.kafka;
...
public class TransactionProducer {
    ...
    public static void main(String[] args) throws Exception{
        ...
        List<String> allData = readAllData("/home/ali/Desktop/AmazonTransactions.csv");
        for(String data : allData) {
            producer.send(new ProducerRecord<>(KafkaConfig.TOPIC, data), (metadata, exception) -> {
                if (exception != null) {
